...
litho_after_main_separator_start(
	...
	litho_meta_box_dropdown(
		'litho_page_layout_setting_single',
	...
	litho_meta_box_dropdown(
		'litho_page_container_style_single',
	...
	litho_meta_box_text(
		'litho_page_container_fluid_with_padding_single',
		esc_html__( 'Full width padding', 'litho-addons' ),
		'',
		'',
		array(
			'element' => 'litho_page_container_style_single',
			'value'   => array( 'default', 'container-fluid-with-padding' ),
		)
	);
	litho_meta_box_dropdown(
		'litho_page_within_content_area_single',
