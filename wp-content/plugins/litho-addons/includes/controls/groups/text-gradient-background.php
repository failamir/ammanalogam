...
/**
 * Litho Text Gradient Background control.
 *
...
if ( ! class_exists( 'LithoAddons\Controls\Groups\Text_Gradient_Background' ) ) {

	/**
	 * Define Text_Gradient_Background class
	 */
	class Text_Gradient_Background extends Group_Control_Base {
		...
		private static function init_background_types() {
			return [
				'solid' => [
					'title' => _x( 'Solid', 'Text Text Background Control', 'litho-addons' ),
					'icon'  => 'eicon-paint-brush',
				],
				'gradient' => [
					'title' => _x( 'Gradient', 'Text Text Background Control', 'litho-addons' ),
					'icon'  => 'eicon-barcode',
				],
			];
		}
		...
		public function init_fields() {
			...
			$fields['background'] = [
				'label'       => _x( 'Color Type', 'Text Background Control', 'litho-addons' ),
				'type'        => 'choose',
				'label_block' => false,
				'render_type' => 'ui',
			];
			...
			$fields['color'] = [
				'label'     => _x( 'Color', 'Text Background Control', 'litho-addons' ),
				'type'      => 'color',
				'default'   => '',
				'title'     => _x( 'Background Color', 'Text Background Control', 'litho-addons' ),
				'selectors' => [
			...
			$fields['color_stop'] = [
				'label'       => _x( 'Location', 'Text Background Control', 'litho-addons' ),
				'type'        => 'slider',
				'size_units'  => [ '%' ],
				'default'     => [
					'unit' => '%',
			...
			$fields['color_b'] = [
				'label'       => _x( 'Second Color', 'Text Background Control', 'litho-addons' ),
				'type'        => 'color',
				'default'     => '#f2295b',
				'render_type' => 'ui',
				'condition'   => [
			...
			$fields['gradient_type'] = [
				'label'   => _x( 'Type', 'Text Background Control', 'litho-addons' ),
				'type'    => 'select',
				'options' => [
					'linear' => _x( 'Linear', 'Text Background Control', 'litho-addons' ),
					'radial' => _x( 'Radial', 'Text Background Control', 'litho-addons' ),
				],
				'default'     => 'linear',
				'render_type' => 'ui',
				'condition'   => [
			...
			$fields['gradient_angle'] = [
				'label'      => _x( 'Angle', 'Text Background Control', 'litho-addons' ),
				'type'       => 'slider',
				'size_units' => [ 'deg' ],
				'default'    => [
					'unit' => 'deg',
			...
			$fields['gradient_position'] = [
				'label'   => _x( 'Position', 'Text Background Control', 'litho-addons' ),
				'type'    => 'select',
				'options' => [
					'center center' => _x( 'Center Center', 'Text Background Control', 'litho-addons' ),
					'center left'   => _x( 'Center Left', 'Text Background Control', 'litho-addons' ),
					'center right'  => _x( 'Center Right', 'Text Background Control', 'litho-addons' ),
					'top center'    => _x( 'Top Center', 'Text Background Control', 'litho-addons' ),
					'top left'      => _x( 'Top Left', 'Text Background Control', 'litho-addons' ),
					'top right'     => _x( 'Top Right', 'Text Background Control', 'litho-addons' ),
					'bottom center' => _x( 'Bottom Center', 'Text Background Control', 'litho-addons' ),
					'bottom left'   => _x( 'Bottom Left', 'Text Background Control', 'litho-addons' ),
					'bottom right'  => _x( 'Bottom Right', 'Text Background Control', 'litho-addons' ),
				],
