		...
		protected function register_controls() {
			...
			$this->add_group_control(
				...
				[
					...
					'selector'	=> '{{WRAPPER}} a.elementor-button:hover, {{WRAPPER}} .elementor-button:hover, {{WRAPPER}} a.elementor-button:focus, {{WRAPPER}} .elementor-button:focus, {{WRAPPER}} a.elementor-button:not(.hvr-btn-expand-ltr):focus, {{WRAPPER}} a.elementor-button.btn-custom-effect:not(.hvr-btn-expand-ltr):focus:before',
				]
			);
			$this->add_group_control(
				Group_Control_Background::get_type(),
