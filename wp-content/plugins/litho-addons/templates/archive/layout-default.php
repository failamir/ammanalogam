								...
								<div class="post-meta-wrapper alt-font">
									...
									if ( 1 == $litho_show_post_author_sticky ) {
										...
										<span class="post-author-meta">
											...
											<span class="author-name"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>">
												<i class="far fa-user blog-icon"></i><?php echo esc_html__( 'By', 'litho-addons' ) . ' ' . esc_html( get_the_author() ); ?></a>
											</span>
										</span>
									<?php } ?>
									<?php
									...
									if ( 1 == $litho_show_comment_sticky && ( comments_open() || get_comments_number() ) ) {
										...
										<span class="post-meta-comments">
											<?php
											echo comments_popup_link( '<i class="far fa-comment"></i><span class="comment-count">0</span> <span class="comment-text">' . esc_html__( 'Comment', 'litho-addons' ) . '</span>', '<i class="far fa-comment"></i><span class="comment-count">1</span> <span class="comment-text">' . esc_html__( 'Comment', 'litho-addons' ) . '</span>', '<i class="far fa-comment"></i><span class="comment-count">%</span> <span class="comment-text">' . esc_html__( 'Comments', 'litho-addons' ) . '</span>', 'comment-link' ); // phpcs:ignore
											?>
										</span>
									<?php } ?>
								</div>
							...
							<div class="blog-post-images">
								...
								<?php if ( 1 == $litho_post_enable_category_archive && has_post_thumbnail() && 1 == $litho_post_enable_thumbnail_archive ) { ?>
									<span class="blog-category alt-font">
										<?php echo litho_post_category( get_the_ID(), true, '1' ); // phpcs:ignore ?>
									</span>
								<?php } ?>
							</div>
							<?php
