...
$litho_portfolio_left_sidebar   = get_theme_mod( 'litho_portfolio_left_sidebar_archive', '' );
$litho_portfolio_right_sidebar  = get_theme_mod( 'litho_portfolio_right_sidebar_archive', 'sidebar-1' );
