...
$litho_product_right_sidebar  = litho_option( 'litho_product_right_sidebar', '' );
$litho_product_left_sidebar   = litho_option( 'litho_product_left_sidebar', '' );
...
switch ( $litho_product_layout_setting ) {
	...
	case 'litho_layout_both_sidebar':
		?>
			...
			<aside id="primary" class="col-12 col-lg-3 sidebar litho-product-sidebar both-sidebar-left litho-blog-sidebar" itemtype="http://schema.org/WPSideBar" itemscope="itemscope">
				<?php
				/**
				 * Fires immediately before siderbar content start
				 *
			...
			<aside id="secondary" class="col-12 col-lg-3 sidebar litho-product-sidebar both-sidebar-right litho-blog-sidebar" itemtype="http://schema.org/WPSideBar" itemscope="itemscope">
				<?php
				/**
				 * Fires immediately before siderbar content start
				 *
